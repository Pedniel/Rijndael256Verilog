...
module shiftrows (
    ...
    // shift left by 1
    assign output_byte[8]  = input_byte[9];  assign output_byte[9]  = input_byte[10];
    assign output_byte[10] = input_byte[11]; assign output_byte[11] = input_byte[12];
    assign output_byte[12] = input_byte[13]; assign output_byte[13] = input_byte[14];
    assign output_byte[14] = input_byte[15]; assign output_byte[15] = input_byte[8];

    // shift left by 3
    assign output_byte[16] = input_byte[19]; assign output_byte[17] = input_byte[20];
    assign output_byte[18] = input_byte[21]; assign output_byte[19] = input_byte[22];
    assign output_byte[20] = input_byte[23]; assign output_byte[21] = input_byte[16];
    assign output_byte[22] = input_byte[17]; assign output_byte[23] = input_byte[18];
